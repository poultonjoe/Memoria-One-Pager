...
/***/ function(module, exports, __webpack_require__) {
	...
	function bindHandlers() {
	    document.addEventListener('click', function (e) {
	        ...
	        (0, _carousel.carousel)(e);
	        (0, _menu.toggleMenu)(e);
	        (0, _menu.scrollTo)(e);
	    }, false);

	    var timeout = null;

	    window.addEventListener('resize', (0, _lodash2.default)(_video.resizeVideo, 150), false);
	}

	function init() {
	    (0, _carousel.appendImages)();
	    bindHandlers();
	    (0, _video.resizeVideo)();
	    (0, _video.videoSlideshow)();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (a) {
	  ...
	  }a.picturefill = ba, "object" == ( false ? "undefined" : _typeof(module)) && "object" == _typeof(module.exports) ? module.exports = ba : "function" == "function" && __webpack_require__(4) && !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return ba;
	  }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)), s.supPicture || (A["image/webp"] = e("image/webp", "data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA=="));
	}(window, document);
...
/***/ function(module, exports) {
	...
	exports.videoSlideshow = videoSlideshow;
...
/***/ function(module, exports) {
	...
	function accordian(e) {
	    ...
	    if (target.parentNode.classList.contains('accordian-slide') && !target.parentNode.classList.contains('open')) {
	        ...
	        setTimeout(function () {
	            return target.parentNode.classList.add('open');
	        });
	    }
	}
...
/***/ function(module, exports) {
	...
	function appendImages() {
	    ...
	    Array.from(slides).forEach(function (slide, activeIndex) {
	        var previousIndex = activeIndex === 0 ? slides.length - 1 : activeIndex - 1;
	        var nextIndex = activeIndex === slides.length - 1 ? 0 : activeIndex + 1;

	        var previousSlide = slides[previousIndex].querySelector('.carousel-image-wrap').cloneNode(true);
	        var nextSlide = slides[nextIndex].querySelector('.carousel-image-wrap').cloneNode(true);
...
/***/ function(module, exports) {
	...
	function scrollTo(e) {
	    if (e.target.classList.contains('site-navigation-link')) {
	        e.preventDefault();
	        var anchor = document.querySelector(e.target.href.substr(e.target.href.lastIndexOf('/') + 1, e.target.href.length - 1));
	        console.log(anchor);
